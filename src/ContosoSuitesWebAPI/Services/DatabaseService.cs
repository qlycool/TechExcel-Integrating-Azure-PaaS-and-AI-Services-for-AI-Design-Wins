...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Retrieves all bookings for a specified hotel that occur after a given minimum date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The minimum date for the bookings to be retrieved.")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all bookings for which do not have hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Retrieves all bookings for which multiple hotel rooms have been booked.")]
